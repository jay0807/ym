...
class site_ctl_admin_widget_proinstance extends site_admin_controller
{
    ...
    public function do_add_widgets(){
        ...
        $this->pagedata['widgetEditor'] = kernel::single('site_widget_proinstance')->editor($widgets, $widgets_app, $widgets_theme, $theme);
    ...
    public function do_edit_widgets(){
        ...
        $this->pagedata['widgetEditor'] = kernel::single('site_widget_proinstance')->editor($widgetObj['widgets_type'],$widgetObj['app'],$widgetObj['theme'],$theme,$widgetObj['params']);
