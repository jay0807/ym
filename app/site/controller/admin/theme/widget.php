...
class site_ctl_admin_theme_widget extends site_admin_controller 
{
    ...
    public function add_widgets_page_extend()
    {
        ...
        $this->pagedata['theme'] = $theme;
        $this->pagedata['widgetsLib'] = kernel::single('site_theme_widget')->get_libs($theme, $catalog);
    ...
    public function do_add_widgets(){
        ...
        $this->pagedata['widgetsApp'] = $widgets_app;
        $this->pagedata['widgetsTheme'] = $widgets_theme;
        $this->pagedata['widgetEditor'] = kernel::single('site_theme_widget')->editor($widgets, $widgets_app, $widgets_theme, $theme);
...
//        header("Cache-Control:no-store, no-cache, must-revalidate"); //强制刷新IE缓存
        ...
        $this->pagedata['widgetEditor'] = kernel::single('site_theme_widget')->editor($widgetObj['widgets_type'],$widgetObj['app'],$widgetObj['theme'],$theme,$widgetObj['params']);
