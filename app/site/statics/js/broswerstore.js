...
(function(){
	...
	BrowserStore=new Class({
	  ...
	  set:function(key,vl){
        this.storage.setStorage=this.storage.setStorage||function(){};
        this.storage.setStorage(key,ts(vl));
        return this;
	  },
	  get:function(key,callback){
         this.storage.getStorage=this.storage.getStorage||function(){};
	     this.storage.getStorage(key,callback);
	  },
	  remove:function(key){

			if (!key || !this.storage) return false;
            this.storage.removeStorage=this.storage.removeStorage||function(){};
			this.storage.removeStorage(key);
            return this;
	  },
	  clear:function(){
			if (!this.storage)return false;
            this.storage.clearStorage=this.storage.clearStorage||function(){};
	 ...
	 //Private Function
	 function ev(v){
	   return v?JSON.decode(v):null;
	 };
	 function ts(v){
      return v?JSON.encode(v):null;
	 };
