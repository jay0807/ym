...
class image_finder_image{
    ...
    function column_img($row){
        ...
        if($row['storage']=='network' && ECAE_MODE!=true){
         return '<a href="'.$row['ident'].'" target="_blank"><img src="'.$row['ident'].'" style="line-height:41px;height:50px;width:50px;text-align:center;background:#efefef;"></a>';
        }else{
